...
The current protocol identity is `scale-crossover-v1-amended-6`. A formal evidence file records the committed bytes and SHA-256 of the frozen protocol plus Amendments 1 through 6, the committed build plan, every source report, and the source commit. The evaluator rejects Amendment 4 evidence, dirty or untracked source reports, a source commit that is not an ancestor of the evidence commit, or a report whose current bytes differ from its recorded commit.
