...
Both are correctness-only and emit no build wall, CPU, `/usr/bin/time`, or peak-RSS evidence. The final full-corpus artifact is 5,961,661 bytes with SHA-256 `0570935049182f87bd479c4ae20dea41d1c2deb8b288b0330dadf0c6b4e2b38d`; the final semantic sentinel is 51,391 bytes with SHA-256 `99649c9d1ee1e0371b0d97ed50f1ac5152bd828acd72392d920855d0b132d551`. The executable gate passes under the explicit correctness execution closure, so correctness no longer blocks attribution or wall execution; the separate frozen host gate still does.
