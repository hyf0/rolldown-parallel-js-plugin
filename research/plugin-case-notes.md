...
- Correctness source: pin official `kit-node`, `preprocess-with-vite`, `svelte-preprocess`, `css-treeshake`, `dynamic-compile-options`, `custom-extensions`, `import-queries`, `kit-async`, `build-watch`, `hmr-css-first`, and `build-multiple` fixtures from plugin-svelte `7.2.0`. [Fixture directory](https://github.com/sveltejs/vite-plugin-svelte/tree/02981fd9bb395b6aa5453e2bc3166778ae71e326/packages/e2e-tests)
