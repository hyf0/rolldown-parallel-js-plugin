...
- [Framing review brief](./research/framing-review.md) condenses the working model, hook-specific direction, proposed sequence, evidence rules, unknowns, and provisional defaults awaiting review.
